...
BLOG_AUTHOR = "Abhimanyu Gupta"  # (translatable)
BLOG_TITLE = "My space on web"  # (translatable)
...
BLOG_EMAIL = "abhimanyu98986@gmail.com"
BLOG_DESCRIPTION = "I pen down my ideas here"  # (translatable)
...
NAVIGATION_LINKS = {
    DEFAULT_LANG: (
        ('/index.html', 'Posts', 'fa fa-home'),
        ('/archive.html', 'Archives', 'fa fa-folder-open'),
        ('/categories/index.html', 'Tags', 'fa fa-tags'),
        ('/rss.xml', 'RSS', 'fa fa-rss'),
        ('https://about.me/theparadoxer02', 'About me', 'fa fa-user'),
        ('https://twitter.com/theparadoxer02', 'My Twitter', 'fa fa-twitter'),
        ('https://github.com/theparadoxer02', 'My Github', 'fa fa-github'),
    )
}
